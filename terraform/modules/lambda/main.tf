...
# Lambda URIs are "{+lambda}/{+function}" e.g. "atp/ping".
# We also support path matching at the root e.g. "atp" but these require definining separate "_root" terraform resources.
