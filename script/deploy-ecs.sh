...
usage="Usage: deploy-ecs.sh [atp-app-web|atp-app-background] [sha]"
...
new_image="101624687637.dkr.ecr.us-west-2.amazonaws.com/atp:$2"
...
aws ecs update-service --cluster atp \
  --no-cli-pager \
  --region "$ecs_region" \
