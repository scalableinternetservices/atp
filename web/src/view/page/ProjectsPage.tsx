    ...
    <>
      ...
      <BodyText>
        <ul className="pl4">
          ...
          <li>
            Must use the class project framework located <Link href="https://github.com/rothfels/atp">here</Link>
          </li>
            ...
            checklistFull={[
              {
                ...
                href: 'https://github.com/rothfels/atp#quickstart',
              },
              {
              ...
              },
              {
                ...
                href: 'https://github.com/rothfels/atp#run-react-storybook',
              },
            ]}
          />
          <Sprint
